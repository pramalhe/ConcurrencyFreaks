...
/**
 * This the same as CLQ but with relaxed traversals
 * 
 ...
 *
 */
public class ConcurrentLinkedQueueRelaxed<E> extends AbstractQueue<E>
        implements Queue<E>, java.io.Serializable {
    private static final long serialVersionUID = 196745693267521677L;
     ...
     */
    public ConcurrentLinkedQueueRelaxed() {
     ...
     */
    public ConcurrentLinkedQueueRelaxed(Collection<? extends E> c) {
    ...
    static {
        try {
            ...
            f.setAccessible(true);
            UNSAFE = (sun.misc.Unsafe) f.get(null);            
            Class k = ConcurrentLinkedQueueRelaxed.class;
